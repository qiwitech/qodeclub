...
$config['smtp_username'] = '';  //Смените на адрес своего почтового ящика.
...
$config['smtp_from'] = 'QODEclub'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого"
...
$cfg['name'] = 'QODEclub';
$cfg['email'] = 'e.hairullin@qiwi.tech';
...
if ($_POST['type']) {
    ...
    switch ($_POST['type']) {
        ...
        case "form1":
            $sender = new Sender();
            $sbj = "Запрос с сайта ".$cfg['name'];
            $msg .= "Имя: ".$data['names']."<br/>";
            $msg .= "Емаил: ".$data['mail']."<br/>";
            $msg .= "Компания: ".$data['company']."<br/>";
            smtpmail($cfg['email'], $cfg['email'], $sbj, $msg);

            break;
        case "form2":
            $sender = new Sender();
            $sbj = "Заказ звонка с сайта ".$cfg['name'];
            $msg = "Ссылка со страницы: ".$data['url']."<br/>";
            $msg .= "Имя: ".$data['name']."<br/>";
            $msg .= "Email: ".$data['mail']."<br/>";
            $msg .= "Текст: ".$data['sms']."<br/>";
            smtpmail($cfg['email'], $cfg['email'], $sbj, $msg);
